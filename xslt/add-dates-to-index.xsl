    ...
    <xsl:template match="tei:bibl">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$v_bibls/descendant-or-self::tei:biblStruct[descendant::tei:biblScope[@unit='issue']/@from=$v_issue]">
                ...
                <!-- get the publication date of this issue -->
                <xsl:variable name="v_date-publication" select="$v_bibls/descendant-or-self::tei:biblStruct[descendant::tei:biblScope[@unit='issue']/@from=$v_issue]/descendant::tei:date[1]/@when"/>
